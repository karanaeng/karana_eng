...
const vercelAdminDir = path.join(rootDir, 'dist', 'admindashboard');
...
fs.rmSync(vercelAdminDir, { recursive: true, force: true });
fs.mkdirSync(vercelAdminDir, { recursive: true });
fs.cpSync(adminDistDir, vercelAdminDir, { recursive: true });

console.log(`Copied admin dashboard build to ${serverAdminDir}`);
console.log(`Copied admin dashboard build to ${vercelAdminDir}`);
